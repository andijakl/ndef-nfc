...
namespace NdefLibraryWin.Ndef
{
    ...
    {
        private const string ProductIdDefault = "-//mopius.com//NDEF Library for NFC//EN";
        ...
        private void UpdatePayload()
        {
            ...
            var icsString = new iCalendarSerializer().SerializeToString(ics);
        ...
        private void ConvertIcalendarToAppointment(byte[] iCalendarPayload)
        {
            ...
            var calendarCollection = iCalendar.LoadFromStream(iCalendarStream);
