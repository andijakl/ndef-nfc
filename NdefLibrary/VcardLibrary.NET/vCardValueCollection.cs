...
namespace VcardLibrary
{
    ...
    /// </summary>
    public class vCardValueCollection : List<string>
    {
        ...
        /// <summary>
        ///     Adds the contents of a ICollection<string> to the collection.
        /// </summary>
        /// <param name="values">
        ///     An initialized ICollection<string> containing zero or more values.
        /// </param>
        public void Add(ICollection<string> values)
        {
            if (values == null)
